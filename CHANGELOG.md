...
* prettify [rcooke-warwick]
* try using innerfile [rcooke-warwick]
* debug: try piping to file first [rcooke-warwick]
* debug: wait longer before trying to flash [rcooke-warwick]
* debug: add even more logging to flashtodisk [rcooke-warwick]
* update multiwrite.pipeSourceToDestinations args [rcooke-warwick]
* debug: add extra log messages [rcooke-warwick]
* package-lock: Update etcher-sdk from 2.0.20 to 7.0.1 [Alexandru Costache]
